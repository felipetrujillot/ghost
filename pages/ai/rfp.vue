...
<template>
  <div class="container container-sm space-y-4">
    ...
    <Card v-if="tabs === 'chat'">
      <div class="relative flex h-full min-h-[50vh] flex-col p-4 lg:col-span-2">
    ...
    <template v-if="tabs === 'resumen'">
      ...
      <Card>
        ...
        <p>
          ...
          información contenida en la cotización confidencial y sin divulgarla a
          terceros hasta el momento en que se firme un contrato entre el cliente
          y Mandante S.A.
        </p>
      </Card>
      ...
      <Card>
        ...
        <p>
          ...
          herramientas de colaboración como sistemas de comunicaciones y gestión
          de tareas. Además, el equipo de soporte debe tener experiencia en la
          ejecución de actividades bajo detención ten prana del monitoreo de
          alertas de seguridad y notificaciones de fuentes externas, así como
          una gestió c y mejora continua de las plataformas de seguridad
        </p>
      </Card>
    </template>
  </div>
